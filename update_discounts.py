...
<html lang="ko">
  <head>
    ...
    <title>오늘의 배달 할인 나침반 | 배민, 쿠팡이츠, 요기요, 땡겨요</title>
    <!-- Pretendard Font for Toss-like clean UI -->
  ...
  <body class="bg-slate-50 text-slate-900 antialiased selection:bg-blue-100 selection:text-blue-600">
    <div id="root"></div>
...
{
  "name": "오늘의 배달 앱 통합 할인 나침반",
  "description": "스마트폰 화면에 최적화된 배달 4사(배민, 쿠팡이츠, 요기요, 땡겨요) 통합 할인 정보 모음 및 비공개 관리자 등록 시스템",
...
View your app in AI Studio: https://ai.studio/apps/a450146f-d83a-40ec-bbfd-c51cf952a70a
